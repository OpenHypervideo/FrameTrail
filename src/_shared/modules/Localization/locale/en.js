...
window.FrameTrail_L10n['en'] = {
    ...
    "MessageCollabMapConflictMerge": "Someone else changed the settings while you were arranging the map. Reload their changes and re-apply your marker positions?",
    "MessageCollabRefreshDiscard": "Reloading will discard your unsaved changes. Continue?",
    "MessageCollabRefreshDiscardMap": "Reloading will discard your unsaved map layout changes. Continue?",
    ...
    "MessageOverviewMap": "Drag the pins to place hypervideos on the background image. Changes are only stored when you save.",
    ...
    "OverviewMapSave": "Save map layout",
    "OverviewMapSaveQuestion": "Do you want to save the changes to the map layout?",
    "OverviewMapSaveQuestionShort": "Unsaved map layout",
